...
sweep3<- sweep2%>%select(-sero_thresh)%>%unique()


sweep4<-rbind(sweep3,sweep3)
sweep4$vax_int <-rep(c(365,730),each =500)
sweep4$vax_start <- rep(c(300/365,300/730),each=500)
sweep4$vax_end <- rep(c(330/365,330/730),each=500)
sweep4 <- sweep4%>%arrange(sweep_unique)

saveRDS(sweep4, "0_sweep_int.RDS")
