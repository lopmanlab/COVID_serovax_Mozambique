...
mod_scen <- readRDS("sw_sens_sero.RDS")
sweep<- readRDS("0_sweep_sero.RDS")

mod_scen_int <- readRDS("sw_sens_int.RDS")
sweep_int <- readRDS("0_sweep_int.RDS")
...
sweep_int$sero_thresh <- rep(c("Annual","Biennial"),times=100)
...
saveRDS(inc, "1_inc_facet_comb100.RDS")
...
saveRDS(sero, "1_sero_facet_comb100.RDS")
...
saveRDS(imm, "1_imm_facet_comb100.RDS")
...
saveRDS(deaths, "1_death_facet_comb100.RDS")
