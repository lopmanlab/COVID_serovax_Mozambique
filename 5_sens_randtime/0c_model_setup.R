...
source("0d_model_code_sero.R")
sweep<- readRDS("0_sweep_sero.RDS")
spec_humid <- read.csv("9_spec_humid.csv")[,c("day","avg_sm3")]
...
model_sims <- function(i){
  ...
  saveRDS(res_out,paste("/projects/blopman/vger/cliu/0_sens/sw_run_",num,".RDS",sep=""))
  return(res_out)
