...
COVID_sero_vax <- function(t, start, params){
  with(as.list(c(start,params)),{
    ...
    ################################
    #Susceptible
    dSpcr1v0  = omega_pc*Rpcr1v0 + omega_pc*W1Rpcr1v0 +omega_pc*W2Rpcr1v0 +omega_pc*W3Rpcr1v0 -kappa1*Spcr1v0 - Spcr1v0 * sd * foi_cr_1v0 - delta1_cr * Spcr1v0 +omega4_pc*Spcr2v0   ##Note vaccination rate here doesnt differ by previous vax status
    dSpcu1v0  = omega_pc*Rpcu1v0 + omega_pc*W1Rpcu1v0 +omega_pc*W2Rpcu1v0 +omega_pc*W3Rpcu1v0-kappa1*Spcu1v0 - Spcu1v0 * sd * foi_cu_1v0 - delta1_cu * Spcu1v0 + omega4_pc*Spcu2v0
    ...
    dSncr1v0  = omega_nc*Rncr1v0 + kappa1*Spcr1v0 -Sncr1v0 * sd * foi_cr_1v0 - delta1_cr * Sncr1v0 + omega4_nc*Sncr2v0##Note vaccination rate here doesnt differ by previous vax status
    dSncu1v0  = omega_nc*Rncu1v0 + kappa1*Spcu1v0 -Sncu1v0 * sd * foi_cu_1v0 - delta1_cu * Sncu1v0 + omega4_nc*Sncu2v0
    ...
    ################################
    #Susceptible
    dSpcr2v0  = omega_pc*Rpcr2v0 -kappa2*Spcr2v0 - Spcr2v0 * sd * foi_cr_2v0 - delta1_cr * Spcr2v0 + omega2_pc*Rpcr3v0 - omega4_pc*Spcr2v0   ##Note vaccination rate here doesnt differ by previous vax status
    dSpcu2v0  = omega_pc*Rpcu2v0 -kappa2*Spcu2v0 - Spcu2v0 * sd * foi_cu_2v0 - delta1_cu * Spcu2v0 + omega2_pc*Rpcu3v0 - omega4_pc*Spcu2v0
    ...
    dSncr2v0  = omega_nc*Rncr2v0 + kappa2*Spcr2v0 -Sncr2v0 * sd * foi_cr_2v0 - delta1_cr * Sncr2v0 + omega2_nc*Rncr3v0- omega4_nc*Sncr2v0 
    dSncu2v0  = omega_nc*Rncu2v0 + kappa2*Spcu2v0 -Sncu2v0 * sd * foi_cu_2v0 - delta1_cu * Sncu2v0 + omega2_nc*Rncu3v0- omega4_nc*Sncu2v0 
    ...
    dSpar1v2  = omega_pa*Rpar1v2 -kappa3*Spar1v2 - Spar1v2 * sd * foi_ar_1v2 - delta3_ar * Spar1v2 +omega3_pa*Spar1v3 + omega4_pa*Spar2v2
    dSpau1v2  = omega_pa*Rpau1v2 -kappa3*Spau1v2 - Spau1v2 * sd * foi_au_1v2 - delta3_au * Spau1v2 +omega3_pa*Spau1v3 + omega4_pa*Spau2v2
    dSper1v2  = omega_pe*Rper1v2 -kappa3*Sper1v2 - Sper1v2 * sd * foi_er_1v2 - delta3_er * Sper1v2 +omega3_pe*Sper1v3 + omega4_pe*Sper2v2
    dSpeu1v2  = omega_pe*Rpeu1v2 -kappa3*Speu1v2 - Speu1v2 * sd * foi_eu_1v2 - delta3_eu * Speu1v2 +omega3_pe*Speu1v3 + omega4_pe*Speu2v2
    ...
    dSnar1v2  = omega_na*Rnar1v2 + kappa3*Spar1v2 -Snar1v2 * sd * foi_ar_1v2 - delta3_ar * Snar1v2 +omega3_na*Snar1v3 +omega4_na*Snar2v2
    dSnau1v2  = omega_na*Rnau1v2 + kappa3*Spau1v2 -Snau1v2 * sd * foi_au_1v2 - delta3_au * Snau1v2 +omega3_na*Snau1v3 +omega4_na*Snau2v2
    dSner1v2  = omega_ne*Rner1v2 + kappa3*Sper1v2 -Sner1v2 * sd * foi_er_1v2 - delta3_er * Sner1v2 +omega3_ne*Sner1v3 +omega4_ne*Sner2v2
    dSneu1v2  = omega_ne*Rneu1v2 + kappa3*Speu1v2 -Sneu1v2 * sd * foi_eu_1v2 - delta3_eu * Sneu1v2 +omega3_ne*Sneu1v3 +omega4_ne*Sneu2v2
    ...
    dSpar2v2  = omega_pa*Rpar2v2 -kappa3*Spar2v2 - Spar2v2 * sd * foi_ar_2v2 - delta3_ar * Spar2v2 + delta2_ar*Spar2v1+ delta2_ar*Snar2v1*(rho_v2)+ omega2_pa*Rpar3v2 +omega3_pa*Spar2v3 -omega4_pa*Spar2v2
    dSpau2v2  = omega_pa*Rpau2v2 -kappa3*Spau2v2 - Spau2v2 * sd * foi_au_2v2 - delta3_au * Spau2v2 + delta2_au*Spau2v1+ delta2_au*Snau2v1*(rho_v2)+ omega2_pa*Rpau3v2 +omega3_pa*Spau2v3 -omega4_pa*Spau2v2
    dSper2v2  = omega_pe*Rper2v2 -kappa3*Sper2v2 - Sper2v2 * sd * foi_er_2v2 - delta3_er * Sper2v2 + delta2_er*Sper2v1+ delta2_er*Sner2v1*(rho_v2)+ omega2_pe*Rper3v2 +omega3_pe*Sper2v3 -omega4_pe*Sper2v2
    dSpeu2v2  = omega_pe*Rpeu2v2 -kappa3*Speu2v2 - Speu2v2 * sd * foi_eu_2v2 - delta3_eu * Speu2v2 + delta2_eu*Speu2v1+ delta2_eu*Sneu2v1*(rho_v2)+ omega2_pe*Rpeu3v2 +omega3_pe*Speu2v3 -omega4_pe*Speu2v2
    ...
    dSnar2v2  = omega_na*Rnar2v2 + kappa3*Spar2v2 -Snar2v2 * sd * foi_ar_2v2 - delta3_ar * Snar2v2 + delta2_ar*Snar2v1*(1-rho_v2) + omega2_na*Rnar3v2 +omega3_na*Snar2v3-omega4_na*Snar2v2
    dSnau2v2  = omega_na*Rnau2v2 + kappa3*Spau2v2 -Snau2v2 * sd * foi_au_2v2 - delta3_au * Snau2v2 + delta2_au*Snau2v1*(1-rho_v2) + omega2_na*Rnau3v2 +omega3_na*Snau2v3-omega4_na*Snau2v2
    dSner2v2  = omega_ne*Rner2v2 + kappa3*Sper2v2 -Sner2v2 * sd * foi_er_2v2 - delta3_er * Sner2v2 + delta2_er*Sner2v1*(1-rho_v2) + omega2_ne*Rner3v2 +omega3_ne*Sner2v3-omega4_ne*Sner2v2
    dSneu2v2  = omega_ne*Rneu2v2 + kappa3*Speu2v2 -Sneu2v2 * sd * foi_eu_2v2 - delta3_eu * Sneu2v2 + delta2_eu*Sneu2v1*(1-rho_v2) + omega2_ne*Rneu3v2 +omega3_ne*Sneu2v3-omega4_ne*Sneu2v2
    ...
    dSper1v3  = omega_pe*Rper1v3 -kappa3*Sper1v3 - Sper1v3 * sd * foi_er_1v3  - omega3_pe*Sper1v3+delta3_er * Sner1v3*rho_v3 +omega4_pe*Sper2v3
    dSpeu1v3  = omega_pe*Rpeu1v3 -kappa3*Speu1v3 - Speu1v3 * sd * foi_eu_1v3  - omega3_pe*Speu1v3+delta3_eu * Sneu1v3*rho_v3 +omega4_pe*Speu2v3
    ...
    dSner1v3  = omega_pe*Rner1v3 + kappa3*Sper1v3 -Sner1v3 * sd * foi_er_1v3 - omega3_ne*Sner1v3- delta3_er * Sner1v3*rho_v3 +omega4_ne*Sner2v3
    dSneu1v3  = omega_pe*Rneu1v3 + kappa3*Speu1v3 -Sneu1v3 * sd * foi_eu_1v3 - omega3_ne*Sneu1v3- delta3_eu * Sneu1v3*rho_v3 +omega4_ne*Sneu2v3
    ...
    dSper2v3  = omega_pe*Rper2v3 -kappa3*Sper2v3 - Sper2v3 * sd * foi_er_2v3 + delta3_er * Sner2v3*rho_v3  + omega2_pe*Rper3v3 - omega3_pe*Sper2v3 - omega4_pe*Sper2v3
    dSpeu2v3  = omega_pe*Rpeu2v3 -kappa3*Speu2v3 - Speu2v3 * sd * foi_eu_2v3 + delta3_eu * Sneu2v3*rho_v3  + omega2_pe*Rpeu3v3 - omega3_pe*Speu2v3 - omega4_pe*Speu2v3
    ...
    dSner2v3  = omega_pe*Rner2v3 + kappa3*Sper2v3 -Sner2v3 * sd * foi_er_2v3 - delta3_er * Sner2v3*rho_v3  + omega2_ne*Rner3v3 - omega3_ne*Sner2v3- omega4_ne*Sner2v3
    dSneu2v3  = omega_pe*Rneu2v3 + kappa3*Speu2v3 -Sneu2v3 * sd * foi_eu_2v3 - delta3_eu * Sneu2v3*rho_v3  + omega2_ne*Rneu3v3 - omega3_ne*Sneu2v3- omega4_ne*Sneu2v3
